...
public class UserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter methodParameter,
        ...
        String cookieToken = getCooieValue(request, SeckillUserService.COOKIE_NAME_TOKEN);
    ...
    private String getCooieValue(HttpServletRequest request, String cookieName) {
